...
# 		#print return_code["contents"]
    ...
    def test_api_buy_query_results_success(self):
        response = self.client.get("/query/", {"symbol":"gld", "start_date":"20090101", "end_date":"20100301", "buy_query":["macd(17,8) is_crossing macd_signal(17,8,9)", "rsi(14) >= 50"]})
        return_code = json.loads(response.content)
        ...
        self.failUnlessEqual(return_code["contents"]["indicators_data"][1][0][0], "rsi(14)")
...
# 		self.failUnlessEqual(len(return_code["contents"]["indicators_data"][149]), 3)
        ...
        self.failUnlessEqual(len(return_code["contents"]["indicators_data"][1][0][1]), 291)
